...
interface ApiInterface {
    ...
    @GET("/api/ebooks/search/{text}")
    fun getSearchDataEbook(@Path("text") search: String):
            Call<DataResponse>
    ...
    @GET("api/all/posts/search/{text}")
    fun getSearchDataAllBlog(
        @Path("text") search: String
    ): Call<DataResponse>
    ...
    @GET("/api/events/search/{text}")
    fun getSearchDataEvent(@Path("text") search: String):
            Call<DataResponse>
